...
namespace Prelab
{
    public partial class Login : Form
    {
        ...
        private void sifre_butonu_TextChanged(object sender, EventArgs e)
        {
            // Kayıtlı kullanıcı şifreleri: admin, user, user2
        }

        public void kullanici_butonu_TextChanged(object sender, EventArgs e)
        {            
            // Kayıtlı kullanıcı adları: admin, admin2, user
        }

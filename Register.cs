...
namespace Prelab
{
    public partial class Register : Form
    {
        ...
        private void kayit_username_TextChanged(object sender, EventArgs e) { }

        private void kayit_password_TextChanged(object sender, EventArgs e) { }

        private void kayit_name_TextChanged(object sender, EventArgs e) { }

        private void kayit_surname_TextChanged(object sender, EventArgs e) { }

        private void kayit_adres_TextChanged(object sender, EventArgs e) { }

        private void kayit_city_TextChanged(object sender, EventArgs e) { }

        private void kayit_country_TextChanged(object sender, EventArgs e) { }

        private void kayit_mail_TextChanged(object sender, EventArgs e) { }
        ...
        private void kayit_exit_Click(object sender, EventArgs e)
        {
            this.Hide();
        }
        ...
        private void Register_Load(object sender, EventArgs e) { }       // form eventi içinden açıyoruz
